...
class TestAuditMiddleware:
    ...
    @pytest.mark.asyncio
    async def test_on_call_tool_logs_invocation(self, caplog: pytest.LogCaptureFixture) -> None:
        ...
        with caplog.at_level(logging.INFO, logger="mp_mcp_server.audit"):
    ...
    @pytest.mark.asyncio
    async def test_on_call_tool_logs_completion(self, caplog: pytest.LogCaptureFixture) -> None:
    ...
    @pytest.mark.asyncio
    async def test_on_call_tool_logs_result_when_enabled(self, caplog: pytest.LogCaptureFixture) -> None:
    ...
    @pytest.mark.asyncio
    async def test_on_call_tool_hides_params_when_disabled(self, caplog: pytest.LogCaptureFixture) -> None:
    ...
    @pytest.mark.asyncio
    async def test_on_call_tool_logs_failure(self, caplog: pytest.LogCaptureFixture) -> None:
        ...
        with (
            caplog.at_level(logging.ERROR, logger="mp_mcp_server.audit"),
