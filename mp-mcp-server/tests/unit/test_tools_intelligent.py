...
class TestAskMixpanelHelpers:
    ...
    def test_get_default_date_range(self) -> None:
        ...
        from mp_mcp_server.tools.intelligent.ask import _get_default_date_range
    ...
    def test_execute_queries(self, mock_context: MagicMock) -> None:
        ...
        from mp_mcp_server.tools.intelligent.ask import _execute_queries
...
class TestAskMixpanelTool:
    ...
    async def test_ask_mixpanel_sampling_unavailable(self, mock_context: MagicMock) -> None:
        ...
        from mp_mcp_server.tools.intelligent.ask import ask_mixpanel
...
class TestDiagnoseHelpers:
    ...
    def test_calculate_date_range(self) -> None:
        ...
        from mp_mcp_server.tools.intelligent.diagnose import _calculate_date_range
    ...
    def test_build_synthesis_prompt(self) -> None:
        ...
        from mp_mcp_server.tools.intelligent.diagnose import _build_synthesis_prompt
    ...
    def test_parse_synthesis_result_valid_json(self) -> None:
        ...
        from mp_mcp_server.tools.intelligent.diagnose import _parse_synthesis_result
...
class TestDiagnoseMetricDropTool:
    ...
    async def test_diagnose_sampling_unavailable(self, mock_context: MagicMock) -> None:
        ...
        from mp_mcp_server.tools.intelligent.diagnose import diagnose_metric_drop
...
class TestFunnelReportHelpers:
    ...
    def test_get_default_date_range(self) -> None:
        """_get_default_date_range should return valid dates."""
        from mp_mcp_server.tools.intelligent.funnel_report import (
...
class TestAskMixpanelSynthesis:
    ...
    @pytest.mark.asyncio
    async def test_ask_mixpanel_synthesis_error(
        self, mock_context: MagicMock
    ) -> None:
...
class TestGenerateExecutionPlanParsing:
    ...
    async def test_generate_plan_empty_response(self, mock_context: MagicMock) -> None:
        ...
        from mp_mcp_server.tools.intelligent.ask import _generate_execution_plan
...
"""
    ...
    @pytest.mark.asyncio
    async def test_generate_plan_plain_code_block(self, mock_context: MagicMock) -> None:
...
class TestFunnelAnalysisFormats:
    ...
    def test_analyze_funnel_steps_with_data_steps(self, mock_context: MagicMock) -> None:
